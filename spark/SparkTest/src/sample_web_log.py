...
class WebLogGeneration(object):
	...
	# ÀàÊôÐÔ£¬ÓÉËùÓÐÀàµÄ¶ÔÏó¹²Ïí
	site_url_base = "http://www.xxx.com/"

	# »ù±¾¹¹Ôìº¯Êý
	def __init__(self):
		#  Ç°Ãæ7ÌõÊÇIE,ËùÒÔ´ó¸Åä¯ÀÀÆ÷ÀàÐÍ70%ÎªIE £¬½ÓÈëÀàÐÍÉÏ£¬20%ÎªÒÆ¶¯Éè±¸£¬·Ö±ðÊÇ7ºÍ8Ìõ,5% Îª¿Õ
	...
	def sample_ip(self):
		slice = random.sample(self.ip_slice_list, 4) #´Óip_slice_listÖÐËæ»ú»ñÈ¡4¸öÔªËØ£¬×÷ÎªÒ»¸öÆ¬¶Ï·µ»Ø
	...
	# Ö÷ÒªËÑË÷ÒýÇæreferrer²ÎÊý
	def sample_refer(self):
		if random.uniform(0, 1) > 0.2:  # Ö»ÓÐ20% Á÷Á¿ÓÐrefer
			return "-"
